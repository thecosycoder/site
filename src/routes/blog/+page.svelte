        ...
        <li class="max-w-3xl w-full mx-auto py-8 border-b border-cool-gray">
          <div>
            <a class="group block mb-6" href={post.path}>
              <h2
                class="relative text-3xl mb-6 capitalize before:content-[''] before:block before:absolute before:bottom-1 before:left-0 before:w-1/2 before:h-7 before:bg-gradient-to-r before:from-coral before:transition before:duration-200 before:ease-in-out before:scale-x-0 before:origin-left group-hover:before:scale-x-100 group-hover:before:origin-left before:-z-10"
              >
                {post.meta.title}
              </h2>
